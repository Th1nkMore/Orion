...
> 本文是 2026-08-29 的实现快照，保留 Route147/197 与早期 Stage-2A 的来龙去脉。当前实验状态、后续门禁和唯一执行顺序见 [`docs/CURRENT_STATE.md`](CURRENT_STATE.md)；若状态字段冲突，以该文件和 `configs/scenario_factory/` 的 hash-bound 协议为准。
