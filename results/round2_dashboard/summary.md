...
- Replay diagnostic baseline ADE@3s: `2.461`.
- Replay diagnostic FiLM ADE@3s: `4.440`.
- Replay collision delta (FiLM - baseline): `-0.0013`.

## Conservative Shortcut Evidence

- Normal replay ADE worsens from `2.776` to `6.003`.
- Adverse replay collision changes from `0.0083` to `0.0064`.
- All-scenario replay brake MAE changes from `0.252` to `0.433`.
- All-scenario replay average speed changes from `4.885` to `4.885`.
