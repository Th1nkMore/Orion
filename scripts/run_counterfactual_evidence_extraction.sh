...
echo "RUN_ID=${run_id}"
echo "SCOPE=counterfactual_evidence_feature_extraction_only"
echo "REFERENCE_FRAMES=720"
echo "OPTIMIZER_TRAIN_FRAMES=560"
...
echo "COUNTERFACTUAL_EVIDENCE_EXTRACTION_OK=1"
