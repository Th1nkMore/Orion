#!/usr/bin/env python3
"""Convert a monolithic FP16 counterfactual shard to route-local int8 shards."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--quantization-batch-size", type=int, default=1)
...
def main() -> int:
    ...
    print(json.dumps({
        ...
        "target_computed_before_input_quantization": manifest[
            "storage_contract"
        ]["targets_computed_from_original_fp16_before_quantization"],
        "adapter_training_performed": False,
        "heldout_data_read": False,
        "stage_b_performed": False,
    }, indent=2, sort_keys=True))
    print("COUNTERFACTUAL_INT8_ROUTE_SHARD_OK=1")
    return 0
