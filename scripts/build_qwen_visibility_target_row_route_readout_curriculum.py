#!/usr/bin/env python3
"""Build the deterministic V1j target-row-disjoint route curriculum."""
...
package = types.ModuleType("_orion_qwen_visibility_target_row_package")
...
def main():
    ...
    curriculum = (
        _curriculum.build_route151_target_row_route_readout_curriculum(
        ...
        json.dumps(
            {
                ...
                "distinct_training_target_pairs": curriculum[
                    "distinct_training_target_pairs"
                ],
                "distinct_evaluation_target_pairs": curriculum[
                    "distinct_evaluation_target_pairs"
                ],
                ...
                "fully_held_out_frame": curriculum["fully_held_out_frame"],
                "optimizer_steps": curriculum["optimizer_steps"],
                "spatial_shuffle_evaluation_role": curriculum[
                    "spatial_shuffle_evaluation_role"
                ],
            },
            indent=2,
            sort_keys=True,
